 ...
 *
 */
public class CustomClazzLoader extends ClassLoader {
  
    /**
     * This constructor is used to set the parent ClassLoader
     */
    public CustomClazzLoader(ClassLoader parent) {
        super(parent);
    }
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("com.my.sngltn.SingleTonScore")) {//condition to break singleton
